...
CREATE TABLE IF NOT EXISTS `benchmark_run` (
  ...
  `source_type` VARCHAR(32) NOT NULL DEFAULT 'mysql_benchmark',
  ...
  `labeled_cases` INT NOT NULL DEFAULT 0,
  `unlabeled_cases` INT NOT NULL DEFAULT 0,
  ...
  `f1_score` DECIMAL(10,8) NULL,
  `accuracy_score` DECIMAL(10,8) NULL,
  `coverage_score` DECIMAL(10,8) NOT NULL DEFAULT 0,
  `effective_recall_score` DECIMAL(10,8) NULL,
...
CREATE TABLE IF NOT EXISTS `benchmark_prediction` (
  ...
  `expected_personal` BOOLEAN NULL,
